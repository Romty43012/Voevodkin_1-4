        ...
        <Container>
            <div className="p-4">
                ...
                <div className="mb-4 p-3 border rounded">
                    ...
                    <p>Текущая тема: <strong>{theme === 'light' ? 'День' : 'Ночь'}</strong></p>
                ...
                <div className="mb-4 p-3 border rounded">
                    ...
                    <p>Локальный счетчик: <strong>{localCount}</strong></p>
                    <div className="d-flex gap-2">
                        ...
                        <Button onClick={() => setLocalCount(0)}>
                            Сбросить
                        </Button>
                    </div>
                </div>
                ...
                <div className="mb-4 p-3 border rounded">
                    ...
                    <p>Статус компонента: <strong>{mounted ? 'Смонтирован' : 'Размонтирован'}</strong></p>
                    <p>Откройте консоль браузера (F12), чтобы увидеть логи</p>
                </div>

                <div className="mb-4 p-3 border rounded">
                    <h4>4. Redux - счетчик с actions и reducer</h4>
                    <p>Redux счетчик: <strong>{count}</strong></p>
                    <div className="d-flex gap-2">
